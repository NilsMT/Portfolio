<template>
    <div id="realisation">
        ...
        <div class="section" id="à-propos">
            ...
            <div id="res">
                Cette SAE avait pour objectif de développer une application web en utilisant des API publiques et un framework web.<br>
        ...
        <div class="section" id="visuels">
            ...
            <div id="cont">
                ...
                <VideoComp desc="Vidéo de présentation (humoristique) du projet et de l'équipe">
                    <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/6RlUISc_nQQ?si=oZDETMi64CnWxi2e" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </VideoComp>
            </div>
        </div>
