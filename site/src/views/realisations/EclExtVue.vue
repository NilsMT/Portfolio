<template>
    <div id="realisation">
        ...
        <div class="section" id="à-propos">
            ...
            <p>
                EclExt est un géostandard gouvernemental de données lié à l'éclairage urbain.
            ...
            <div id="res">
                Cet outil de standardisation de données est un outil développé pendant mon stage de 2<sup>ème</sup>
                année de BUT Informatique au sein de L'Observatoire de la Nuit.<br>
                Il permet de faciliter l'usage des fichiers de données de points lumineux fournis par les collectivités locales
                et territoriales dans les applications de l'entreprise.
            </div>
        ...
        <div class="section" id="images">
            ...
            <div id="cont">
                <ImgComp imgName="EclExt/etape1.png" desc="L'étape 1 de l'outil : La configuration" />

                <ImgComp imgName="EclExt/etape2.png" desc="L'étape 2 de l'outil : La standardisation des colonnes" />

                <ImgComp imgName="EclExt/etape3.png" desc="L'étape 3 de l'outil : La standardisation des attributs" />
