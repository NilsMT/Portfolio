<template>
    <div id="realisation">
        ...
        <div class="section" id="à-propos">
            ...
            <p>
                ...
                <a
                    ...
                    href="https://github.com/NilsMT/Puissance-Quatre"
                >
            ...
            <p>
                J'ai commencé par faire un diagramme représentant le déroulement
                d'une partie au niveau des échanges d'informations entre les
                acteurs (deux clients et un serveur).<br />Puis je l'ai
                développé en respectant ce diagramme pour maintenir une
                cohérence.
            </p>
        </div>
        ...
        <div class="section" id="visuels">
            ...
            <div id="cont">
                <VideoComp desc="Vidéo de démonstration du projet">
                    <video controls="" height="480" allow="autoplay">
                        <source
                            src="../../assets/video/RealisationsDetails/puissancequatre_demo.mp4"
                            type="video/mp4"
                        />
                    </video>
                </VideoComp>
                ...
                <ImgComp
                    imgName="PuissanceQuatre/schema.png"
                    desc="Diagramme des échanges"
                />
            </div>
        </div>
